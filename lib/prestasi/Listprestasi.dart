...
import 'package:pelanggaran/prestasi/EditPrestasi.dart';
import 'package:pelanggaran/prestasi/TambahPrestasi.dart';
...
class SiswaData {
  ...
  factory SiswaData.fromJson(Map<String, dynamic> json) {
    return SiswaData(
      ...
      jenis: json['jenis'],
      detaill: json['detail'] == null ? "" : json['detail'],
    );
  }
}
  ...
  void fetchDataKota(String query) async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://34.101.47.131/prestasiapi?search=$query"),
        headers: {
          'Cookie': token,
        },
      );
