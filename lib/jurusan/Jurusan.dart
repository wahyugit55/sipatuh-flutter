...
import 'package:pelanggaran/jurusan/EditJurusan.dart';
import 'package:pelanggaran/jurusan/JuruanTambah.dart';
  ...
  void fetchDataKota(String query) async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://34.101.47.131/jurusanapi?search=$query"),
        headers: {
          'Cookie': token,
        },
      );
